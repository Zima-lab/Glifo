...
def glyph_bounds(fontpath, ch, size=100):
    """Riquadro reale del glifo (xMin, yMin, xMax, yMax) alla dimensione data.
    Serve per allineare fra loro lettere prese da font diversi: l'altezza
    dell'occhio varia molto da un carattere all'altro, e a parità di corpo
    due « o » sembrerebbero di misure diverse."""
    f = _font(fontpath)
    gs = f.getGlyphSet()
